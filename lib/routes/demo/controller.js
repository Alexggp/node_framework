...
const post = [
  checkSchema((req)=>req.body,schema.post),    //validation middleware, always at first position in the array
  (req, res) => {
    demoService.entry(res.locals.payload, function (err, result) {
